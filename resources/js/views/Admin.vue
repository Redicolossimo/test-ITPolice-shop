...
export default {
    ...
    beforeMount() {
        ...
        this.user = JSON.parse(localStorage.getItem('e-shop.  d fuser'))
...
<style scoped>
.hero-section { height: 20vh; background: rgba(111, 39, 182, 0.51);; align-items: center; margin-bottom: 20px; margin-top: -20px; }
